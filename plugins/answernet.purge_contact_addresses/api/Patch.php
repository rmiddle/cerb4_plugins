<?php
  class AnswernetPurgeContactAddressesPatchContainer extends DevblocksPatchContainerExtension {
	function __construct($manifest) {
		...
		$this->registerPatch(new DevblocksPatch('answernet.purge_contact_addresses',3,$file_prefix.'/4.2.3.php',''));
	}
};
